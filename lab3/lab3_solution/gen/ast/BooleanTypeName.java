...
public class BooleanTypeName extends TypeName implements Cloneable {
  ...
  public BooleanTypeName clone() throws CloneNotSupportedException {
    BooleanTypeName node = (BooleanTypeName)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public BooleanTypeName copy() {
      try {
        BooleanTypeName node = (BooleanTypeName)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public BooleanTypeName fullCopy() {
    try {
      BooleanTypeName tree = (BooleanTypeName) clone();
   ...
   * @apilevel internal
   */
  private TypeDescriptor getDescriptor_compute() {  return TypeDescriptor.BOOLEAN;  }
}
