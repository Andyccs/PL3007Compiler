...
/**
 * @production IntTypeName : {@link TypeName};
 * @ast node
 * @declaredat C:/Users/Andy/Desktop/PL3007Compiler/lab3/lab3_solution/src/frontend/grammar.ast:20
 */
public class IntTypeName extends TypeName implements Cloneable {
  /**
   * @apilevel low-level
   */
  ...
  public IntTypeName clone() throws CloneNotSupportedException {
    IntTypeName node = (IntTypeName)super.clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public IntTypeName copy() {
      try {
        IntTypeName node = (IntTypeName)clone();
   ...
   */
  @SuppressWarnings({"unchecked", "cast"})
  public IntTypeName fullCopy() {
    try {
      IntTypeName tree = (IntTypeName) clone();
   ...
   * @aspect types
   * @declaredat C:/Users/Andy/Desktop/PL3007Compiler/lab3/lab3_solution/src/frontend/types.jrag:22
   */
  @SuppressWarnings({"unchecked", "cast"})
   ...
   * @apilevel internal
   */
  private TypeDescriptor getDescriptor_compute() {  return TypeDescriptor.INT;  }
}
